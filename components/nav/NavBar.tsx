  ...
  return (
    <>
      <nav className="flex justify-between align-center max-w-screen-2xl mx-auto px-3 md:px-8 p-6 md:p-8 text-gray1 w-full">
        <Link className="flex justify-center items-center text-center invisible md:visible" href="/">
          <img
            id="logo"
        ...
        <ul className="flex justify-center items-center">
          <li slot="basic" className="mx-2 lg:mx-4 hover:scale-105 transition-transform invisible lg:visible w-0 lg:w-fit h-0 lg:h-fit">
            <a
            ...
            >
              <img className="h-10 mr-2" src="https://supaship.io/supaship_logo.svg" />
              <div className="grid place-items-center font-sans">
                <span className="inline-block">get the course to build this site on fireship</span>
                <span className="inline-block">use coupon: "SUPASHIP" for 50% off!</span>
              </div>
              <img className="h-10 ml-2" src="https://supaship.io/supaship_logo.svg" />
            </a>
          </li>
          ...
          <li className="mx-2 md:mx-4 hover:scale-105 transition-transform">
            <Link href="message-board/1" className="font-sans text-xl font-bold leading-none text-gray2 gradient-slide">
              message board
            </Link>
          </li>
          ...
          <li className="ml-2 mr-6 relative">{session?.user ? <UserMenu profile={profile} /> : <LoginButton session={session} />}</li>
        </ul>
      </nav>
      <Dialog
        open={showProDialog}
        ...
        contents={
          <>
            <div className="flex flex-col content-center gap-6">
              <h2 className="text-green-400 drop-shadow-[0_0_9px_rgba(34,197,94,0.9)] m-4 text-center text-3xl">We're not quite ready yet</h2>
              <p className="text-center">
                Expect the course to drop sometime around Thanksgiving 2022. In the meantime - you can checkout the{" "}
                <a
              ...
              <a href="https://fireship.io/courses" target="_blank" rel="noreferrer" className="grid place-content-center">
                <img
                  src="https://fireship.io/img/logo.svg"
                  className="h-24 hover:drop-shadow-[0_0_9px_rgba(34,197,94,0.9)] transition duration-500"
                />
              </a>
              <p className="text-center">Be sure to checkout our YouTube channels as well for more coding vids:</p>
...
function YoutubeChannelLink({ channelUrl, channelName, iconImgUrl }: { channelUrl: string; channelName: string; iconImgUrl: string }) {
  return (
    <a
      href={channelUrl}
      target="_blank"
    ...
    >
      <div className="grid place-content-center">
        <img src={iconImgUrl} className="rounded-full h-24 w-24 object-cover text-center" />
      </div>
