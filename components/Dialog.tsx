...
export default function Dialog({ allowClose = true, contents, open, dialogStateChange = () => {} }: DialogProps) {
      ...
      >
        <div className="relative my-6 mx-auto w-128">
          <div className="relative group">
            ...
            <div ref={dialog} className="relative p-6 bg-black rounded-lg grid place-content-center">
              {contents}
            </div>
          </div>
        </div>
